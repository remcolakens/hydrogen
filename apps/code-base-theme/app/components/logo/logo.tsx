import { Icon } from '@code-internet-applications/icon';
...
const Logo: FC<ILogoProps> = ({
	...
	const logoViewbox = text ? '0 0 105 28' : '0 0 28 28';
	...
	return (
		...
		>
			<g clipPath="url(#a)">
				<path fill={colors.primary} d="M28 14 14 0h14v14Z M14 0 28 14H14V0Z" />
